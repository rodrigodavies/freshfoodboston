...
if ( ! function_exists( 'colabs_shortcode_stylesheet' ) && get_option( 'framework_colabs_disable_shortcodes' ) != 'true' ) {
	function colabs_shortcode_stylesheet() {
		wp_enqueue_style( 'shortcodestyle', get_template_directory_uri() .'/functions/css/shortcodes.css');
	}
}
...
function colabs_shortcode_typography_loadgooglefonts ( $font = '' ) {
	...
	if ( $font ) {
		...
		wp_enqueue_style( 'googlefontstyle', 'http'. ( is_ssl() ? 's' : '' ) .'://fonts.googleapis.com/css?family=' . $f_include);
...
function colabs_shortcode_linkedin_js () {
	wp_enqueue_script( 'linkedinjs', 'http://platform.linkedin.com/in.js', array( 'jquery' ));
...
function colabs_shortcode_pinterest_javascript () {
	...
	wp_enqueue_script( 'pinitjs', 'http://assets.pinterest.com/js/pinit.js', array( 'jquery' ));
