...
function colabsthemes_sbm_page(){
	...
	jQuery(document).ready(function() {
		...
		function colabs_sbm_description(sidebar,name,type){
			...
			var message = '<?php esc_attr_e("This sidebar will replace the","colabsthemes"); ?> '+sidebar+' <?php esc_attr_e("sidebar on the","colabsthemes"); ?> '+name+' '+type+'.';
			return message;
		}
...
<div class="wrap colabs_container">
    ...
    <div id="main" class="sbm-content">
    	...
    	<div id="sidebar-nav" class="colabs-sbm-menu">
			...
			?>
				<li>
					<a href="#"><?php _e('Custom Post Type','colabsthemes');?> <span>[+]</span></a>
					<?php
						$_html = '';
			...
			?>
				<li>
					<a href="#"><?php _e('Post Type Archives','colabsthemes');?> <span>[+]</span></a>
					<?php
						$_html = '';
							$_html .= '<ul>' . "\n";
