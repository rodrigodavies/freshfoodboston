...
function colabsthemes_add_admin() {
  ...
  if(get_option( 'framework_colabs_backend_icon')) { $icon = get_option( 'framework_colabs_backend_icon' ); }
	...
	$colabspage = '';
    $colabspage =add_theme_page ( $themename.__(' Panel','colabsthemes'), $themename.__(' Panel','colabsthemes'), 'edit_theme_options','colabsthemes','colabsthemes_options_page', $icon);

	// Add SEO Menu Item
	$colabsseo = '';
	if ( get_option( 'framework_colabs_seo_disable') != 'true' )
    $colabsseo = add_theme_page( __('SEO Setting','colabsthemes'), __('SEO Setting','colabsthemes'), 'edit_theme_options', 'colabsthemes_seo', 'colabsthemes_seo_page' );

	// Add Dashboard Menu Item
    $colabsdash = '';
    $colabsdash = add_theme_page( __('Theme Info','colabsthemes'), __('Theme Info','colabsthemes'), 'edit_theme_options', 'colabsthemes_info', 'colabsthemes_dashboard_page' );
    ...
    $colabslayout = add_theme_page( __('Layout Settings','colabsthemes'), __('Layout Settings','colabsthemes'), 'edit_theme_options', 'colabsthemes_layout_settings', 'colabsthemes_layout_settings_page' );
	
	// Add Custom Editor Menu Item
	$colabseditor = '';
	if ( get_option( 'framework_colabs_editor_disable') != 'true' && file_exists(COLABS_CUSTOM) )
    $colabseditor = add_theme_page( __('Custom File Editor','colabsthemes'), __('Custom File Editor','colabsthemes'), 'edit_theme_options', 'colabsthemes_editor', array('colabs_custom_editor', 'options_page') );
	
	 // Add README.txt file submenu, if it exists
    $colabsthemes_readme_menu_pagehook = file_exists( get_template_directory() . '/README.txt' ) ? add_theme_page( __('Readme','colabsthemes'), __('Readme','colabsthemes'), 'edit_theme_options', 'readme', 'colabsthemes_readme_menu_admin' ) : null;
...
<div class="wrap colabs_container">
    ...
    // Rev up the Options Machine
        ...
        <div id="main" class="menu-item-settings metabox-holder">
          ...
          <div id="panel-header">
                <?php colabsthemes_options_page_header( array( 'themename'=>$themename ) ); ?>
          </div><!-- #panel-header -->
      ...
      <div id="panel-content">
        ...
        <div class="save-bar save_bar_top right">
          ...
          <input type="submit" value="<?php esc_attr_e( 'Save Changes', 'colabsthemes' ); ?>" class="button submit-button button-primary" />
          ...
          <form action="" method="post" style="display:inline" id="colabsform-reset">
            ...
            ?>
              <input name="reset" type="submit" value="<?php esc_attr_e( 'Reset Options', 'colabsthemes' ); ?>" class="button submit-button reset-button button-highlighted" onclick="return confirm( '<?php _e("Click OK to reset all options. All settings will be lost!","colabsthemes"); ?>' );" />
...
function colabs_admin_head() {
	wp_enqueue_style( 'admin-style', get_template_directory_uri() . '/functions/admin-style.css');
	wp_enqueue_style( 'datepicker-style', get_template_directory_uri() . '/functions/css/jquery-ui-datepicker.css');
	wp_enqueue_style( 'colorpickerstyle', get_template_directory_uri() . '/functions/css/colorpicker.css');
	wp_enqueue_script( 'colorpickerjs', get_template_directory_uri() .'/functions/js/colorpicker.js', array( 'jquery' ));
	
/* To change the CSS stylesheet depending on the chosen color */
global $_wp_admin_css_colors;
if(isset($_wp_admin_css_colors['name'])){
	wp_enqueue_style( 'choosenstyle', get_template_directory_uri() . '/'.$_wp_admin_css_colors['name']);
  ...
  <?php
  //AJAX Upload
  wp_enqueue_script( 'ajaxupload', get_template_directory_uri().'/functions/js/ajaxupload.js', array( 'jquery' ));
  ?>
  ...
  foreach ($options as $value) {
    ...
    //Start Heading
     if ( $value['type'] != "heading" )
     {
      ...
      $output .= '<div class="section section-double-input '. $class .'">'."\n";
	  }else{
    ...
    if ( $value['type'] != "heading" ) { 
      ...
      $output .= '</div><span class="description"><label for="'.$value['id'].'">'. $explain_value .'</label></span>'."\n";
